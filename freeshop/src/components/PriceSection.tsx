...
const PriceSection: FC<{ price: number; discountPercentage: number }> = ({
  ...
  if (Math.floor(discount) === 0) {
    return <h2 className="font-medium text-orange-600 text-xl">{price}грн</h2>;
  }
  return (
    <div className="leading-3">
      <h2 className="font-medium text-orange-600 text-xl">
        {result.toFixed(2)}грн
      </h2>
      <span className="mr-2 text-sm line-through opacity-70">{price}грн</span>
